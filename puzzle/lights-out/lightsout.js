...
class Lightsout extends HTMLElement {
    constructor() {
        super();
    ...
    redraw() {
        ...
        wrapper.innerHTML = `
<p id="score">이동 횟수: <span id="moves"></span></p>
<p><button id="solve">자동 풀기</button></p>
`;
...
`;
    ...
    playSolution(solution) {
        if (solution.length == 0) {
            this.solve_button.textContent = '자동 풀기';
            this.gameState = State.PLAYING;
            return;
        }
    ...
    solve() {
        ...
        this.solve_button.textContent = '취소';
...
if (!customElements.get('lightsout-game')) {
    customElements.define('lightsout-game', Lightsout);
}
