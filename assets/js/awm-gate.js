...
(function () {
  ...
  function injectStyle() {
    ...
    s.textContent =
      ...
      // pre-paint(body>*:not(#natas-header) 숨김, 특정도 1,1,2)이 페이월까지 가려 빈 화면 버그 →
      // 동일 특정도(body>#awm-paywall) + 후순위 주입으로 페이월 강제 표시
      "html.awm-gated body>#awm-paywall,html.awm-gated body>#awm-paywall *{visibility:visible!important}" +
